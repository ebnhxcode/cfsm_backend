...
<ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Graficos acumulado (muestras)</li>
    </ol>
    ...
    <div class="row">
        ...
        <a href="{!!URL::to('/graficoconsolidado')!!}" class="btn btn btn-success   btn-block"> Finalizar <i class="far fa-save"></i> </a>
